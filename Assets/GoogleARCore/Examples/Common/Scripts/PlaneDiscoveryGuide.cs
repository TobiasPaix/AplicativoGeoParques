    ...
    public class PlaneDiscoveryGuide : MonoBehaviour
    {
        ...
        private void UpdateUI()
        {
                ...
                Session.LostTrackingReason != LostTrackingReason.None)
            {
                ...
                switch (Session.LostTrackingReason)
                {
                    case LostTrackingReason.InsufficientLight:
                        _snackBarText.text = "Muito escuro. Tente se mover para uma área mais iluminada.";
                        break;
                    case LostTrackingReason.InsufficientFeatures:
                        _snackBarText.text = "Mire o dispositivo em uma superfície com mais textura ou cor.";
                        break;
                    case LostTrackingReason.ExcessiveMotion:
                        _snackBarText.text = "Muito rápido. Vá mais devagar.";
                        break;
                    case LostTrackingReason.CameraUnavailable:
                        _snackBarText.text = "Outro aplicativo está usando a câmera. Selecione esse app " +
                            "ou tente fechar o outro.";
                        break;
                    default:
                        _snackBarText.text = "Rastreamento de movimento perdido.";
                        break;
                }
            ...
            if (_notDetectedPlaneElapsed > DisplayGuideDelay)
            {
                ...
                {
                    _snackBarText.text = "Precisa de ajuda?";
                    _openButton.SetActive(true);
                }
                else
                {
                    _snackBarText.text = "Aponte a câmera para o local que deseja colocar o objeto.";
                    _openButton.SetActive(false);
                }
            }
